...
void QmitkExtActionBarAdvisor::MakeActions(berry::IWorkbenchWindow* window)
{
  QAction* fileOpenAction = new QmitkFileOpenAction(
                              QIcon::fromTheme("document-open",
                                               QIcon(":/org_mitk_cbica_captk_icons/icons/tango/scalable/actions/document-open.svg")),
                              window);
  ...
  fileSaveProjectAction->setIcon(QIcon::fromTheme("document-save",
                                                  QIcon(":/org_mitk_cbica_captk_icons/icons/tango/scalable/actions/document-save.svg")));
  ...
  closeProjectAction->setIcon(QIcon::fromTheme("edit-delete",
                                               QIcon(":/org_mitk_cbica_captk_icons/icons/tango/scalable/actions/edit-delete.svg")));
  ...
  fileExitAction->setIcon(QIcon::fromTheme("system-log-out", QIcon(":/org_mitk_cbica_captk_icons/icons/tango/scalable/actions/system-log-out.svg")));
